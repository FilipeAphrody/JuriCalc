...
class OvertimeCalculationSerializer(serializers.Serializer):
    ...
    overtime_percentage = serializers.DecimalField(max_digits=5, decimal_places=4, default='0.50')
    work_hours_monthly = serializers.DecimalField(max_digits=5, decimal_places=2, default='220.00')
