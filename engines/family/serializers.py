...
class AlimonyArrearsSerializer(serializers.Serializer):
    ...
    interest_rate = serializers.DecimalField(max_digits=5, decimal_places=4, default='0.01')
    fine_percentage = serializers.DecimalField(max_digits=5, decimal_places=4, default='0.10')
